...
void disS(float score){
    score=score/92;
    cout<<"Your Decimal Score is:"<<endl;
    cout<<score<<endl;
}
void disS(int score){
    cout<<"Your Numeric Score is:"<<endl;
    cout<<score<<endl;
}
void oDis(float score){
    int score2=score+1-1;
    int useri; //Userinput
    cout<<"Do you want to display your score in numeric or by percentage"<<endl;
    cout<<"Enter 1 for decimal, 2 for numeric, 3 for both"<<endl;
    cin>>useri;
    switch (useri){
        case 1:disS(score);break;
